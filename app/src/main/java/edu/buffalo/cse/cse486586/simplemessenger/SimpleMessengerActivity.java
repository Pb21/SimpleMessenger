...
*/
               ...
               Log.d(TAG,"Yesss"+userInput);
           //     if((userInput = incoming.readLine()) != null) {
                   // out.println(userInput);
                   publishProgress(userInput);
                 //   Log.d(TAG,"Yesss"+userInput);
           //     }

                //  out.print(incoming.readLine());
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                /*Write to PrintWriter object to send data to server*/
                 //PrintWriter out=new PrintWriter(socket.getOutputStream(), true);
  //              PrintWriter out = new PrintWriter(new BufferedWriter(new OutputStreamWriter(socket.getOutputStream())),true);
                /*To get server response read from BufferedReader*/
               //  BufferedReader in= new BufferedReader(new InputStreamReader(socket.getInputStream()));
               // BufferedReader inStream=new BufferedReader(new InputStreamReader(System.in));
               // String input;

                out.write(msgToSend.getBytes());
                Log.d(TAG,"done"+msgToSend);
                out.flush();
